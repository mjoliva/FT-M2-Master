...
document.querySelector("#createdBy").innerHTML = 'Aplicación creada por Jesu Oliva'
...
function buildToDos(toDos) {
 ...
 /* newToDoArray = []
  ...
  let newToDoArray = toDos.map(buildToDo)
...
let divsArray = buildToDos(toDoItems)

divsArray.forEach(function(toDoDiv){
...
function addToDo() {
  ...
  if(!input.value) return alert('Escribe algo para agregar')
